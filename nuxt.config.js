  ...
  head: {
    ...
    meta: [
      ...
      { name: "viewport", content: "width=750" },
      {
        ...
        name: "description",
        content:
          "ウミベプランニングはコンテンツプロデューサー・プランナー楠瀬薫子の屋号です。クリエイティブコンテンツの企画制作を通じ、人を笑顔に、世界をハッピーにするお手伝いをします。受託での企画制作業とオリジナル水着ブランドCOLCA(コルカ)の運営を行っています。"
      },
      {
        hid: "og:title",
        name: "og:title",
        content: "ウミベプランニング | クリエイティブコンテンツ企画制作"
      },
      ...
      { hid: "og:url", name: "og:url", content: "http://umibe-planning.jp" },
      {
        hid: "og:site_name",
        name: "og:site_name",
        content: "ウミベプランニング | クリエイティブコンテンツ企画"
      },
      {
        hid: "og:description",
        name: "og:description",
        content:
          "ウミベプランニングはクリエイティブコンテンツの企画制作を通じ、人を笑顔に、世界をハッピーにするお手伝いをします。受託での企画制作業とオリジナルブランドCOLCA(コルカ)の運営を行っています。"
      },
      {
        hid: "og:image",
        name: "og:image",
        content: "http://umibe-planning.jp/ogp.png"
      }
    ],
    link: [
